...
class CircleTest {
    ...
    public void testCalculateFromRadius() {
        ...
        assertAll(
                () -> assertEquals(circle.getPerimeter(), 2 * Math.PI * randomInput, epsilon),
    ...
    public void testCalculateFromDiameter() {
        ...
        assertAll(
                () -> assertEquals(circle.getPerimeter(), 2 * Math.PI * (randomInput / 2), epsilon),
    ...
    public void testCalculateFromCircumference() {
        ...
        assertAll(
                () -> assertEquals(circle.getPerimeter(), randomInput, epsilon),
    ...
    public void testCalculateFromArea() {
        ...
        assertAll(
                () -> assertEquals(circle.getPerimeter(), 2 * Math.PI * Math.sqrt(randomInput / Math.PI), epsilon),
